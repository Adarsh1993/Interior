...
public class InteriorDashboard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_interior_dashboard);
        ...
        uploadImages.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                permissions = new Permissions(InteriorDashboard.this);
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                try {
                                    ...
                                    DrawingAdapter = new ArrayAdapter<DrawingImages>(InteriorDashboard.this, R.layout.spinner_text, R.id.spinner_text, drawingImages);
    ...
    private void GetProject() {
        try {
            ...
            if (CheckNetwork.isInternetAvailable(InteriorDashboard.this)) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            zoneAdapter = new ArrayAdapter<Zone>(InteriorDashboard.this, R.layout.spinner_text, R.id.spinner_text, getZone);
                        ...
                        try {
                            ...
                            try {
                                ...
                                for (int i = 0; i < project_array.length(); i++) {
                                    ...
                                    final ArrayAdapter<Project_model> arrayAdapter = new ArrayAdapter<Project_model>(InteriorDashboard.this, R.layout.spinner_text, R.id.spinner_text, project_models);
                            ...
                            try {
                                ...
                                Toast.makeText(InteriorDashboard.this, "" + project_response, Toast.LENGTH_SHORT).show();
                            } catch (Exception e) {
                                ProgressDismiss();
            ...
            imgView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (!mLocationManager.isProviderEnabled(LocationManager.GPS_PROVIDER)) {
                        Toast.makeText(InteriorDashboard.this, "Please Enable Location/GPS", Toast.LENGTH_SHORT).show();
                    } else {
                        if (nearResponses.get(finalI).getCateone() != null && !nearResponses.get(finalI).getCateone().equalsIgnoreCase("normal")) {
                            Toast.makeText(InteriorDashboard.this, "" + getResources().getString(R.string.walkThrough_point), Toast.LENGTH_SHORT).show();
    ...
    void getProgressShow(String Message) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                pd = new ProgressDialog(InteriorDashboard.this);
    ...
    void FilePAth() {
        ...
        if (imageCount == 0) {
            Toast.makeText(InteriorDashboard.this, "No Image Found", Toast.LENGTH_SHORT).show();
            ProgressDismiss();
        } else {
                    ...
                    public void run() {
                        ...
                        if (bool == true) {
                            ...
                            if (finalLength == 0) {
                                ...
                                uploadStatusButton();
                                setPoint();
                                Toast.makeText(InteriorDashboard.this, "Images successfully uploaded. Check on OpticVyu web-dashboard", Toast.LENGTH_LONG).show();
                            ...
                            ProgressDismiss();
                            Toast.makeText(InteriorDashboard.this, "Something Went Wrong", Toast.LENGTH_SHORT).show();
    ...
    void alert() {
        Dialog deleteDialog = new Dialog(InteriorDashboard.this, R.style.MyAlertDialogTheme);
    ...
    void Instruction() {
        Dialog ins = new Dialog(InteriorDashboard.this, R.style.MyAlertDialogTheme);
    ...
    void NormalCamera() {
        Dialog dialog = new Dialog(InteriorDashboard.this, R.style.MyAlertDialogTheme);
    ...
    void PopupMenu() {
        cameraModePreferences = getApplicationContext().getSharedPreferences(Constants.CameraSelectionMode, MODE_PRIVATE);
        SharedPreferences.Editor editor = cameraModePreferences.edit();
        PopupMenu popup = new PopupMenu(InteriorDashboard.this, menu);
        //Inflating the Popup using xml file
        popup.getMenuInflater().inflate(R.menu.poupup_menu, popup.getMenu());

        if (Constants.Mode.equals(getString(R.string.insta_360))) {
            hdrMode.setVisibility(View.GONE);
            if (Constants.RadioCheck == 1) {
                popup.getMenu().getItem(0).setChecked(true);
            } else {
                popup.getMenu().getItem(0).setChecked(false);
            }
        } else {
            hdrMode.setVisibility(View.VISIBLE);
            if (Constants.RadioCheck == 1) {
        ...
        popup.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if (item.getTitle().equals(getString(R.string.ContactUs))) {
                    //startActivity(new Intent(InteriorDashboard.this, ContactUS.class));

                } else if (item.getTitle().equals(getString(R.string.Website))) {
                    startActivity(new Intent(InteriorDashboard.this, Website.class));
                ...
                } else if (item.getTitle().equals(getString(R.string.Cache))) {
                    CacheCLear(InteriorDashboard.this);


                }
                else if(item.getTitle().equals("Walkthrough"))
                {
                    Intent in =  new Intent(InteriorDashboard.this, Sensor.class);
                    startActivity(in);
                }
                else if (item.getTitle().equals("Insta 360")) {
                    hdrMode.setVisibility(View.VISIBLE);
                    if (item.isChecked()) {
                        Constants.RadioCheck = 0;
                        item.setChecked(false);

                    } else {
                        openCamera();
                        item.setChecked(true);
                        Constants.RadioCheck = 1;
                        hrd_option = new HRD_option(InteriorDashboard.this, new HRD_option.OnOptionSelectedListener() {
                            @Override
                            public void onOptionSelected(String option) {
                                if (option.equals("ON")) {
                                    hdrOption = true;
                                    hdrMode.setText("HDR- ON");
                                    editor.putBoolean("hdrMode", hdrOption).commit();
                                    Toast.makeText(InteriorDashboard.this, "HDR ON", Toast.LENGTH_SHORT).show();
                                } else {
                                    hdrOption = false;
                                    hdrMode.setText("HDR- OFF");
                                    editor.putBoolean("hdrMode", hdrOption).commit();
                                    Toast.makeText(InteriorDashboard.this, "HDR OFF", Toast.LENGTH_SHORT).show();
                                }
                    ...
                    editor.putString("selectionMode", getString(R.string.insta_360));
                    editor.commit();
                    Constants.Mode = getString(R.string.insta_360);
                    return true;

                } else if (item.getTitle().equals("Richo 360")) {
                    hdrMode.setVisibility(View.GONE);
                    if (item.isChecked()) {
                        item.setChecked(false);
                        Constants.RadioCheck = 0;
                    ...
                    editor.putString("selectionMode", getString(R.string.richo_360));
                    editor.commit();
                    Constants.Mode = getString(R.string.richo_360);
                    return true;
                } else {

                    SharedPreferences sharedPreferences = getApplicationContext().getSharedPreferences(Constants.APP_PREFERENCE, MODE_PRIVATE);
                    SharedPreferences sharedPreferences1 = getApplicationContext().getSharedPreferences(Constants.APP_Remember, MODE_PRIVATE);
                    SharedPreferences.Editor sed = sharedPreferences.edit();
                    SharedPreferences.Editor sed1 = sharedPreferences1.edit();
                    sed1.putString(Constants.User_Email, "");
                    sed1.putString("Password", "");
                    sed.putBoolean(Constants.LOGIN_PREFERENCE, false);
                    sed.clear().commit();
                    sed.clear().commit();
                    sed1.clear().commit();
                    realmController.DeleteRealmData();
                    startActivity(new Intent(InteriorDashboard.this, LoginScreenActivity.class));
                    finish();
                }
                return true;
            }
    ...
    public class ShootTask extends AsyncTask<Void, Void, HttpConnector.ShootResult> {
        ...
        protected HttpConnector.ShootResult doInBackground(Void... params) {
            mMv.setSource(null);
            ShootTask.CaptureListener postviewListener = new ShootTask.CaptureListener();
    ...
    void OfflineZone() {
        if (realmController.getZones(ProjectID).size() > 0) {
            ...
            if (CheckNetwork.isInternetAvailable(InteriorDashboard.this)) {
                ...
                NetNotConnectForZone();
                connectionAlert.NetLocal(InteriorDashboard.this);
            }
            ...
            public void onFailure(Call call, IOException e) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        ActiveNetWork(InteriorDashboard.this);
